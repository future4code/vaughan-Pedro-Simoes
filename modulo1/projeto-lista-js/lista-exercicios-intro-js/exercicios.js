...
const resutando = anoAtual - nacimento
console.log(resultado)
return resultado
}
...
function calculaIngressosEspetaculo(custo, valorIngresso) {
  // implemente sua lógica aqui
const custo2 = 5000
const valordovalorIngresso = 40
const resultado = custo2 / valorIngresso
...
function checaStringsMesmoTamanho(string1, string2) {
  // implemente sua lógica aqui
const string3 = "ola tudo bem"
const string6= "como voce vai"
const resultado1 = string3.length
const resultado2 = string6.length
console.log (resutando1 <= resutando2)
}

// EXERCÍCIO 09
function retornaPrimeiroElemento(array) {
  // implemente sua lógica aqui
  const lista = (manga, maca, goiaba) 
console.log(lista[0])
}
...
function checaIgualdadeDesconsiderandoCase(string1, string2) {
  // implemente sua lógica aqui
const frase1 = "ola tudo bem!"
const frase2 = "ola como voce vai!"
