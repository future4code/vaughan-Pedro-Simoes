...
const nacimento= prompt ("Qual é o ano que voce naceu?")
...
function calculaIMC(peso, altura) {
  // implemente sua lógica aqui
const Altura = prompt("Qual e a sua Altura?")
const peso1 = prompt ("Qual e o seu peso?")
...
function calculaIngressosEspetaculo(custo, valorIngresso) {
  // implemente sua lógica aqui
const custo2 =Number.prompt ("Qual e o custo do salao")
const valorIngresso2 =Number.prompt ("qual e o valor do ingresso")
const resultado = custo2 / valorIngresso2
console.log(resutando)
...
function checaStringsMesmoTamanho(string1, string2) {
  // implemente sua lógica aqui
const string3 = prompt ("escreva uma frase")
...
function trocaPrimeiroEUltimo(array) {
  // implemente sua lógica aqui
let numeros =Number.prompt ("escreva tres numeros")
...
function checaIgualdadeDesconsiderandoCase(string1, string2) {
  // implemente sua lógica aqui
const frase1 = promot ("escreva uma frase")
